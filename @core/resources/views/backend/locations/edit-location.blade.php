                    ...
                    <div class="card-body">
                        ...
                        <form action="{{route('admin.locations.update')}}" method="post">
                            ...
                            <div class="row">
                                ...
                                @php
                                    $selectedDivision = old('division', $location->division);
                                    $selectedDistrict = old('district', $location->district);
                                    $selectedUpazila = old('upazila', $location->upazila);
                                @endphp
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="division">{{__('Division')}}</label>
                                        <select name="division" id="division" onchange="divisionsList();"
                                            class="form-control  @error('division') @enderror">
                                            <option value="" @if(empty($selectedDivision)) selected @endif>Select Division</option>
                                            <option value="Barishal" @if($selectedDivision === 'Barishal') selected @endif>বরিশাল (Barishal)</option>
                                            <option value="Chattogram" @if($selectedDivision === 'Chattogram') selected @endif>চট্টগ্রাম (Chattogram)</option>
                                            <option value="Dhaka" @if($selectedDivision === 'Dhaka') selected @endif>ঢাকা (Dhaka)</option>
                                            <option value="Khulna" @if($selectedDivision === 'Khulna') selected @endif>খুলনা (Khulna)</option>
                                            <option value="Mymensingh" @if($selectedDivision === 'Mymensingh') selected @endif>ময়মনসিংহ (Mymensingh)</option>
                                            <option value="Rajshahi" @if($selectedDivision === 'Rajshahi') selected @endif>রাজশাহী (Rajshahi)</option>
                                            <option value="Rangpur" @if($selectedDivision === 'Rangpur') selected @endif>রংপুর (Rangpur)</option>
                                            <option value="Sylhet" @if($selectedDivision === 'Sylhet') selected @endif>সিলেট (Sylhet)</option>
                                    ...
                                    <div class="form-group">
                                        <label for="district">{{__('District')}}</label>
                                         <select name="district" id="district" onchange="upazilaList();"
                                            class="form-control  @error('district') border-red-500 @enderror">
                                            <option value="" @if(empty($selectedDistrict)) selected @endif>Select District</option>
                                        </select>
                                        @error('district')
                                            <div class="text-red mt-2 font-medium text-sm">
                                                {{ $message }}
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select name="upazila" id="upazila"
                                            class="form-control @error('upazila') border-red-500 @enderror">
                                            <option value="" @if(empty($selectedUpazila)) selected @endif>Select Upazila</option>
                                        </select>
                                        @error('upazila')
                                            <div class="text-red mt-2 font-medium text-sm">
                                                {{ $message }}
...
function upazilaList() {
    ...
    (function () {
        const selectedDivision = @json($selectedDivision);

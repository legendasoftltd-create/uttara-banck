...
<div class="col-lg-12 col-ml-12 padding-bottom-30">
    <div class="row">
        ...
        <div class="col-lg-12 mt-5">
                ...
                <div class="card-body">
                    ...
                    <form action="{{route('admin.services.update')}}" method="post" enctype="multipart/form-data">
                        ...
                        <select name="icon_type" class="form-control" id="edit_icon_type">
                            <option @if($service->icon_type == 'icon') selected @endif value="icon">{{__("Font Icon")}}
                            </option>
                            <option @if($service->icon_type == 'image') selected @endif
                                value="image">{{__("Image Icon")}}</option>
                        </select>
                </div>
            ...
            <div class="form-group">
                ...
                <input type="text" name="meta_tags" class="form-control" value="{{$service->meta_tag}}"
            ...
            <select name="categories_id" id="category" class="form-control">
                ...
                <option @if($service->categories_id == $data->id) selected @endif value="{{$data->id}}">{{$data->name}}
                </option>
                @endforeach
            </select>
        </div>
        ...
        <select name="price_plan[]" multiple class="form-control nice-select wide" id="price_plan_select">
            ...
            <option value="{{$data->id}}" @if(is_array($select_plan) && in_array($data->id,$select_plan)) selected
    ...
    <div class="form-group">
        ...
        <label class="switch d-block">
            <input type="checkbox" name="updated_date_status" value="on" @if(!empty($service->updated_date_status)) checked @endif>

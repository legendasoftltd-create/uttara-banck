...
@section('content')
    <div class="col-lg-12 col-ml-12 padding-bottom-30">
        <div class="row">
            ...
            <div class="@if(check_page_permission('services_category_create')) col-lg-6 @else col-lg-12 @endif mt-5">
                <div class="card">
                    <div class="card-body">
                        <h4 class="header-title">{{__('All Categories')}}</h4>
                        @if(check_page_permission('services_category_delete'))
                                        ...
                                        @foreach($category as $data)
                                            <tr>
                                                ...
                                                <td>
                                                     ...
                                                     @endif
                                                     @if(check_page_permission('services_category_edit'))
                                                    <a href="#"
                                                       data-toggle="modal"
            ...
            @if(check_page_permission('services_category_create'))

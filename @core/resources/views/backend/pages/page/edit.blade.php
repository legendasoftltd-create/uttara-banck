                        ...
                        <div class="row">
                            <div class="col-lg-8">
                                <div class="form-group">
                                    ...
                                    <select name="lang" id="language" class="form-control">
                                        ...
                                        <option @if($page_post->lang == $lang->slug) selected @endif
                            ...
                            <div
                                ...
                                <div class="summernote"
                                    data-content='{{iFrameFilterInSummernoteAndRender($page_post->content)}}'></div>
                            </div>
                            <div
                                ...
                                <a href="{{route('admin.dynamic.page.builder',['type' =>'dynamic-page','id' => $page_post->id])}}"
                                    target="_blank" class="btn btn-primary"> <i class="fas fa-external-link-alt"></i>
                                    {{__('Open Page Builder')}}</a>
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <select name="visibility" class="form-control">
                                    <option @if($page_post->visibility === 'all') selected @endif
                                        value="all">{{__('All')}}</option>
                                    <option @if($page_post->visibility === 'user') selected @endif
                                        value="user">{{__('Only Logged In User')}}</option>
                                </select>
                            </div>
                            <div class="form-group">

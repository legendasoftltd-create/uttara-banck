                        ...
                        @foreach($all_blog as $data )
                            <div class="single-portfolio-blog-grid industry-page">
                                ...
                                <div class="content">
                                    ...
                                    <a class="readmore" href="{{route('frontend.news.single',$data->slug)}}">{{filter_static_option_value('portfolio_news_section_'.$user_select_lang_slug.'_button_text',$static_field_data)}}</a>
                                </div>
                            </div>
                        @endforeach
                    </div>

                        ...
                        <div class="slick-slider-items">
                            <div class="single-blog">
                                ...
                                <div class="blog-contents mt-4">
                                    <h2 class="blog-title"> <a href="{{route('frontend.news.single', $blog->slug)}}">{{$blog->title}}</a> </h2>
                                    <div class="blog-bottom mt-4">
                                        <a href="{{route('frontend.news.single', $blog->slug)}}" class="reading-btn"> {{filter_static_option_value('home_21_blog_section_'.$user_select_lang_slug.'_item_keep_reading_text',$static_field_data)}} <i class="fas fa-arrow-right"></i> </a>
                                    </div>
                                </div>
                            </div>
                        </div>

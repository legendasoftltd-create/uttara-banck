                                ...
                                <div class="banner-contents-wrapper">
                                    ...
                                    <div class="banner-contents">
                                        <div class="tag-title-contents padding-bottom-20">
                                            ...
                                            <span class="banner-dates"> {{$slider_item->published_at->format('d M Y')}}</span>
                                        </div>
                                        <h2 class="banner-title"><a href="#">{{$slider_item->title}}</a></h2>
                                        <div class="btn-wrapper">
                                            <a href="{{route('frontend.news.single',$slider_item->slug)}}" class="cmn-btn"> {{filter_static_option_value('home_20_header_section_'.$user_select_lang_slug.'_readmore_text',$static_field_data)}}</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="video-wrapper">
                                <div class="single-videos">
                                    ...
                                    <div class="video-contents">
                                        <h2 class="video-title"> <a href="{{route('frontend.news.single',$slider_item->slug)}}">{{$vd_item->title}}</a> </h2>
                    ...
                    <div class="single-sports">
                        ...
                        <div class="sports-contents">
                            <div class="tag-title-contents padding-bottom-10">
                                ...
                                <span class="banner-dates"> {{$sport_news->published_at->format('d M Y')}}</span>
                            </div>
            ...
            <div class="slick-slide">
                <div class="single-topics">
                    ...
                    <div class="topics-contents">
                        <span class="global-dates mb-3">  {{$hot_news->published_at->format('d M Y')}}</span>
                        <div class="tag-title-contents padding-bottom-10">
                            {!! get_blog_category_by_id($hot_news->blog_categories_id,'link','tag-title') !!}
                        </div>
                        <h4 class="topics-title"> <a href="{{route('frontend.news.single',$hot_news->slug)}}">{{$hot_news->title}}</a> </h4>

                            ...
                            @foreach($all_blog as $data )
                                <div class="single-portfolio-blog-grid cleaning-home">
                                    ...
                                    <div class="content">
                                        ...
                                        <a class="readmore" href="{{route('frontend.news.single',$data->slug)}}">{{filter_static_option_value('home_page_16_'.$user_select_lang_slug.'_new_area_button_text',$static_field_data)}}</a>
                                    </div>
                                </div>
                            @endforeach
                        </div>

                            ...
                            @foreach($all_blog as $data )
                                <div class="single-portfolio-blog-grid medical-home">
                                    ...
                                    <div class="content">
                                        ...
                                        <a class="readmore" href="{{route('frontend.news.single',$data->slug)}}">{{filter_static_option_value('home_page_12_'.$user_select_lang_slug.'_news_section_readmore_text',$static_field_data)}} <i class="fas fa-long-arrow-alt-right"></i></a>
                                    </div>
                                </div>
                            @endforeach
                        </div>

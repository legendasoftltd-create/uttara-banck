...
<section class="auction-page-section">
    <div class="container">
        ...
        <div class="year-filter-bar">
            ...
            <select id="filter_year_select" class="year-filter-select" onchange="filterAuctions()">
            ...
            <select id="filter_month_select" class="year-filter-select" onchange="filterAuctions()">

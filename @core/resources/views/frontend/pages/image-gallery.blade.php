...
<style>
    ...
    .custom-select-btn {
        ...
        background-color: #2e7d4f; /* green color — change to your brand color */
        color: #fff;
        border: none;
        border-radius: 6px;
        padding: 10px 16px;
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    // ON CHANGE FILTER
    document.getElementById('categoryFilter').addEventListener('change', loadGallery);
    document.getElementById('yearFilter').addEventListener('change', loadGallery);

...
<section class="notice-page-section">
    <div class="container">
        ...
        <div class="year-filter-bar">
            ...
            <select id="filter_year_select" class="year-filter-select" onchange="filterNotices()">
            ...
            <select id="filter_month_select" class="year-filter-select" onchange="filterNotices()">

            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="text-center">
                        <h3 class="text-theme-green fw-semibold mb-0">{{__('Search For:')}} {{$search_term}}</h3>
                                        ...
                                        <div class="mb-3 mb-md-0">
                                            ...
                                            <div class="d-flex flex-wrap align-items-center icon-text fw-normal">
                                                ...
                                                <span class="d-flex align-items-center">
                                                    ...
                                                    <span class="description-font">{{ $data->experience ?? 'Experience Negotiable' }}</span>
                                                </span>
                                            </div>
                                        </div>
                    ...
                    <div class="widget-area">
                        <div class="widget mb-5">
                            <form action="{{ route('frontend.jobs.search') }}" method="GET">
                                <div class="mb-3">
                                    <input type="text" name="search" class="form-control sidebar-search-input" placeholder="Search..." value="{{ $search_term ?? '' }}">
                                </div>

                                ...
                                <div class="cat-sku-content-wrapper">
                                    ...
                                    <div class="share-wrap">
                                       <ul class="social-icons">
                                           ...
                                           {!! single_post_share(route('frontend.news.single',$product->slug),$product->title,$post_img) !!}
                                       </ul>
                                    </div>
                                </div>
                            </div>
    ...
    @if (count($related_products) > 0 && !empty(get_static_option('product_single_related_products_status')))
        <section class="related-products">
            ...
            @endforeach
                {{-- <div class="product-card">
                    <div class="image-container">
                        <img src="https://brackweb.s3.ap-southeast-1.amazonaws.com/uploads/all/SME-Uddipon-1188x60068b7daf63bff2.jpg"
                            alt="UDDIPON Fixed Deposit">
                    </div>
                    <div class="card-content">
                        <h3 class="product-name">UDDIPON Fixed Deposit</h3>
                    </div>
                </div>

                <div class="product-card">
                    <div class="image-container">
                        <img src="https://brackweb.s3.ap-southeast-1.amazonaws.com/uploads/all/BBPLC_All_Card-5768a8da4a12d08_(1)68b69a02f2f8d.png"
                            alt="Smart Farmer's Debit Card">
                    </div>
                    <div class="card-content">
                        <h3 class="product-name">Smart Farmer's Debit Card</h3>
                    </div>
                </div> --}}
            </div>
        </section>
                ...
                $(document).on('click', '.product_variant_add_to_cart', function(e) {
                    ...
                    if (variants != variantSelected) {
                        $(this).parent().parent().append(
                            '<p class="text-danger">{{ __('Select Product Variants') }}</p>');
                    } else {

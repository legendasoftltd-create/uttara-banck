                        ...
                        <?php if(count($all_tags) > 1): ?> 
                            <div class="left">
                                <ul class="tags">
                                    ...
                                    ?> 
                                    <?php if(!empty($slug)): ?>
                                        <li><a href="<?php echo e(route('frontend.news.tags.page',['name' => $slug])); ?>"><?php echo e($tag); ?></a></li>
                                    <?php endif; ?>
                        ...
                        <?php endif; ?>
                            <div class="right">
                                <ul class="social-share">
                                    ...
                                    <?php echo single_post_share(route('frontend.news.single',$blog_post->slug),$blog_post->title,$post_img); ?>
                            ...
                            <div class="related-news-carousel margin-top-30">
                                <?php $__currentLoopData = $all_related_blog; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <div class="single-blog-grid-02">
                                        ...
                                        <div class="content">
                                            <h4 class="title"><a href="<?php echo e(route('frontend.news.single',$data->slug)); ?>"><?php echo e($data->title); ?></a></h4>
                                        </div>
                                    </div>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </div>
...
<?php echo $__env->make('frontend.frontend-page-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/ubank.example.com/@core/resources/views/frontend/pages/blog/blog-single.blade.php ENDPATH**/ ?>
    ...
    <?php if(count($related_products) > 0 && !empty(get_static_option('product_single_related_products_status'))): ?>
        <section class="related-products">
            ...
            <?php $__currentLoopData = $related_products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="<?php echo e($data->category_id == 3 ? 'card-product' : 'product-card'); ?>">
...
<?php echo $__env->make('frontend.frontend-page-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp8.2\htdocs\uttara-banck\@core\resources\views/frontend/pages/products/product-single.blade.php ENDPATH**/ ?>
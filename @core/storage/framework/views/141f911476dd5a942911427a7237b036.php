...
<footer class="footer ">
    ...
    <div class=" py-2">
        <hr>
        <p class="text-[#012C60] text-center font-light md:text-base"><?php echo get_footer_copyright_text(); ?></p>
    </div>
</footer>
...
<!-- Javascript files-->
<script src="<?php echo e(asset('assets/frontend/assets/js/jquery-3.6.0.min.js')); ?>"></script>
...
<script src="<?php echo e(asset('assets/frontend/assets/js/jquery.cookie.js')); ?>"></script>
<script src="<?php echo e(asset('assets/frontend/assets/js/jquery.waypoints.min.js')); ?>"></script>
<script src="<?php echo e(asset('assets/frontend/assets/js/jquery.counterup.min.js')); ?>"></script>
<script src="<?php echo e(asset('assets/frontend/assets/js/owl.carousel.js')); ?>"></script>
<script src="<?php echo e(asset('assets/frontend/assets/js/owl.carousel2.thumbs.min.js')); ?>"></script>
<script src="<?php echo e(asset('assets/frontend/assets/js/jquery.parallax-1.1.3.js')); ?>"></script>
<script src="<?php echo e(asset('assets/frontend/assets/js/bootstrap-select.min.js')); ?>"></script>
<script src="<?php echo e(asset('assets/frontend/assets/js/jquery.scrollTo.min.js')); ?>"></script>
<script src="<?php echo e(asset('assets/frontend/assets/js/front.js')); ?>"></script>
<script src="<?php echo e(asset('assets/frontend/assets/js/waypoint.min.js')); ?>"></script>
<script src="<?php echo e(asset('assets/frontend/assets/js/custom_v2.js')); ?>"></script>
<script src="<?php echo e(asset('assets/frontend/assets/js/isInViewport.js')); ?>"></script>
<script src="<?php echo e(asset('assets/frontend/assets/js/active.js')); ?>"></script>
<script src="<?php echo e(asset('assets/frontend/assets/js/modernizr.min.js')); ?>"></script>
<script src="<?php echo e(asset('assets/frontend/assets/js/jquery.touchSwipe.min.js')); ?>"></script>
<script src="https://cdn.jsdelivr.net/npm/swiper/swiper-bundle.min.js"></script>

<script src="<?php echo e(asset('assets/frontend/assets/js/script-custom.js')); ?>"></script>
...
</html> <?php /**PATH /var/www/html/ubank.example.com/@core/resources/views/frontend/partials/footer.blade.php ENDPATH**/ ?>
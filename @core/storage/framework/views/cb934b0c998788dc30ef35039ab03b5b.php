                ...
                <div class="card">
                    <div class="card-body">
                        <div class="header-wrap d-flex justify-content-between">
                            <h4 class="header-title"><?php echo e(__('Add New Bank Location')); ?></h4>
                            <a href="<?php echo e(route('admin.locations.all')); ?>" class="btn btn-primary"><?php echo e(__('All Locations')); ?></a>
                        </div>

                        <form action="<?php echo e(route('admin.locations.new')); ?>" method="post">
                            <?php echo csrf_field(); ?>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="name"><?php echo e(__('Name / Title')); ?></label>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="type"><?php echo e(__('Location Type')); ?></label>
                                        <select name="type" id="type" class="form-control">
                                            <option value="branch"><?php echo e(__('Branch')); ?></option>
                                            <option value="sub_branch"><?php echo e(__('Sub Branch')); ?></option>
                                            <option value="atm"><?php echo e(__('ATM')); ?></option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="branch_point"><?php echo e(__('Branch Point')); ?></label>
                                        <select name="branch_point" id="branch_point" class="form-control">
                                            <option value="Branches"><?php echo e(__('Branches')); ?></option>
                                            <option value="AD Branches"><?php echo e(__('AD Branches')); ?></option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="branch" name="branch" value="<?php echo e(old('branch')); ?>">
                                    </div>
                                </div>
                                <?php
                                    $selectedDivision = old('division', '');
                                    $selectedDistrict = old('district', '');
                                    $selectedUpazila = old('upazila', '');
                                ?>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="division"><?php echo e(__('Division')); ?></label>
...
unset($__errorArgs, $__bag); ?>">
                                            <option value="" <?php if(empty($selectedDivision)): ?> selected <?php endif; ?>>Select Division</option>
                                            <option value="Barishal" <?php if($selectedDivision === 'Barishal'): ?> selected <?php endif; ?>>বরিশাল (Barishal)</option>
                                            <option value="Chattogram" <?php if($selectedDivision === 'Chattogram'): ?> selected <?php endif; ?>>চট্টগ্রাম (Chattogram)</option>
                                            <option value="Dhaka" <?php if($selectedDivision === 'Dhaka'): ?> selected <?php endif; ?>>ঢাকা (Dhaka)</option>
                                            <option value="Khulna" <?php if($selectedDivision === 'Khulna'): ?> selected <?php endif; ?>>খুলনা (Khulna)</option>
                                            <option value="Mymensingh" <?php if($selectedDivision === 'Mymensingh'): ?> selected <?php endif; ?>>ময়মনসিংহ (Mymensingh)</option>
                                            <option value="Rajshahi" <?php if($selectedDivision === 'Rajshahi'): ?> selected <?php endif; ?>>রাজশাহী (Rajshahi)</option>
                                            <option value="Rangpur" <?php if($selectedDivision === 'Rangpur'): ?> selected <?php endif; ?>>রংপুর (Rangpur)</option>
                                            <option value="Sylhet" <?php if($selectedDivision === 'Sylhet'): ?> selected <?php endif; ?>>সিলেট (Sylhet)</option>
...
$message = $__bag->first($__errorArgs[0]); ?>
                                            <div class="text-red mt-2 font-medium text-sm">
                                                <?php echo e($message); ?>
...
unset($__errorArgs, $__bag); ?>
                                        <!--<input type="text" class="form-control" id="division" name="division" value="<?php echo e(old('division')); ?>">-->
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="district"><?php echo e(__('District')); ?></label>
...
unset($__errorArgs, $__bag); ?>">
                                            <option value="" <?php if(empty($selectedDistrict)): ?> selected <?php endif; ?>>Select District</option>
                                        </select>
...
unset($__errorArgs, $__bag); ?>
                                        <!--<input type="text" class="form-control" id="district" name="district" value="<?php echo e(old('district')); ?>">-->
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="upazila"><?php echo e(__('Upazila')); ?></label>
                                        <select name="upazila" id="upazila"
                                            class="form-control <?php $__errorArgs = ['upazila'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                                            <option value="" <?php if(empty($selectedUpazila)): ?> selected <?php endif; ?>>Select Upazila</option>
                                        </select>
...
unset($__errorArgs, $__bag); ?>
                                        <!--<input type="text" class="form-control" id="upazila" name="upazila" value="<?php echo e(old('upazila')); ?>">-->
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="fax"><?php echo e(__('Fax')); ?></label>
                                        <input type="text" class="form-control" id="fax" name="fax" value="<?php echo e(old('fax')); ?>">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="routing_no"><?php echo e(__('Routing No')); ?></label>
                                        <input type="text" class="form-control" id="routing_no" name="routing_no" value="<?php echo e(old('routing_no')); ?>">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="dates"><?php echo e(__('Dates')); ?></label>
                                        <input type="text" class="form-control" id="dates" name="dates" value="<?php echo e(old('dates')); ?>">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="date_opening"><?php echo e(__('Date Opening')); ?></label>
                                        <input type="date" class="form-control" id="date_opening" name="date_opening" value="<?php echo e(old('date_opening')); ?>">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="gstatus"><?php echo e(__('GStatus')); ?></label>
                                        <input type="text" class="form-control" id="gstatus" name="gstatus" value="<?php echo e(old('gstatus')); ?>">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="dhaka_branch"><?php echo e(__('Dhaka Branch')); ?></label>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="locker"><?php echo e(__('Locker Available')); ?></label>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="status"><?php echo e(__('Publish Status')); ?></label>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="map"><?php echo e(__('Map Embed / Link')); ?></label>
                                        <textarea class="form-control" id="map" name="map" rows="4"><?php echo e(old('map')); ?></textarea>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <div class="media-upload-btn-wrapper">
                                            ...
                                            <button type="button" class="btn btn-info media_upload_form_btn" data-btntitle="<?php echo e(__('Select Location Image')); ?>" data-modaltitle="<?php echo e(__('Upload Location Image')); ?>" data-toggle="modal" data-target="#media_upload_modal">
                                ...
                                <div class="col-md-12">
                                    <button type="submit" class="btn btn-primary mt-4 pr-4 pl-4"><?php echo e(__('Add New Location')); ?></button>
                                </div>
                            </div>
                        </form>
                    </div>
...
function upazilaList() {
    ...
    (function () {
        const selectedDivision = <?php echo json_encode($selectedDivision, 15, 512) ?>;
        const selectedDistrict = <?php echo json_encode($selectedDistrict, 15, 512) ?>;
        const selectedUpazila = <?php echo json_encode($selectedUpazila, 15, 512) ?>;
        const divisionField = document.getElementById('division');
        const districtField = document.getElementById('district');
        const upazilaField = document.getElementById('upazila');

        if (selectedDivision) {
            divisionField.value = selectedDivision;
            divisionsList();
        }

        if (selectedDistrict) {
            districtField.value = selectedDistrict;
            upazilaList();
        }

        if (selectedUpazila) {
            upazilaField.value = selectedUpazila;
        }
    })();
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/ubank.example.com/@core/resources/views/backend/locations/new-location.blade.php ENDPATH**/ ?>
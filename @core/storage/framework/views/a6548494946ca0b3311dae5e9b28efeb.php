<?php $__env->startSection('site-title'); ?>
    <?php echo e(__('Bank Download Categories')); ?>
...
<?php endif; ?>
            ...
            <div class="col-lg-8 mt-5">
                <div class="card">
                    <div class="card-body">
                        <h4 class="header-title"><?php echo e(__('Bank Download Categories')); ?></h4>
                        ...
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                            <?php $a=0; ?>
                            <?php $__currentLoopData = $all_categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $categories): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li class="nav-item">
                                    <a class="nav-link <?php if($a == 0): ?> active <?php endif; ?>"  data-toggle="tab" href="#category_tab_<?php echo e($key); ?>" role="tab" aria-controls="home" aria-selected="true"><?php echo e(get_language_by_slug($key)); ?></a>
                                </li>
                                <?php $a++; ?>
                        ...
                        <div class="tab-content margin-top-40" id="myTabContent">
                            <?php $b=0; ?>
                            <?php $__currentLoopData = $all_categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $categories): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="tab-pane fade <?php if($b == 0): ?> show active <?php endif; ?>" id="category_tab_<?php echo e($key); ?>" role="tabpanel" >
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.delete-popover','data' => ['url' => route('admin.bank.download.category.delete',$data->id)]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['url' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('admin.bank.download.category.delete',$data->id))]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
            ...
            <div class="col-lg-4 mt-5">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form method="POST" action="<?php echo e(route('admin.bank.download.category')); ?>">
                            <?php echo csrf_field(); ?>
                            <div class="form-group">
                                <label for="title"><?php echo e(__('Title')); ?></label>
                                <input type="text" id="title" name="title" class="form-control" placeholder="<?php echo e(__('Title')); ?>" required>
                            </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="editModalLabel"><?php echo e(__('Edit Category')); ?></h5>
                ...
                <form id="edit_category_form" method="POST">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn btn-primary"><?php echo e(__('Update Category')); ?></button>
                    </div>
                </form>
            </div>
        </div>
...
<?php $__env->startSection('script'); ?>
    ...
    <script src="<?php echo e(asset('assets/backend/js/bulk-action.js')); ?>"></script>
    <script>
        $(document).on('click', '.category_edit_btn', function() {
            ...
            $('#edit_category_form').attr('action', '<?php echo e(route("admin.bank.download.category.update")); ?>');
        });
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/ubank.example.com/@core/resources/views/backend/pages/bank-download/category.blade.php ENDPATH**/ ?>
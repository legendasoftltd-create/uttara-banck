                    ...
                    <div class="card-body">
                        ...
                        <form action="<?php echo e(route('admin.general.preloader.settings')); ?>" method="Post" enctype="multipart/form-data">
                            ...
                            <div class="form-group custom_preloader_field_wrapper" style="display: <?php if(!empty(get_static_option('preloader_custom'))): ?> block <?php else: ?> none <?php endif; ?>">
                                ...
                                <small class="form-text text-muted"><?php echo e(__('allowed image format: jpg,jpeg,png,webp,gif.')); ?></small>
                            </div>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/ubank.example.com/@core/resources/views/backend/general-settings/preloader-settings.blade.php ENDPATH**/ ?>
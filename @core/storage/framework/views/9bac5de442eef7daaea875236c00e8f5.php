        ...
        <div class="content">
            <div class="Robi-Ad" style="line-height: 1; position: fixed; height: 140px; left: -149px;">
                <a class="handle" href="<?php echo e(route('frontend.locations')); ?>?tab=atm" target="_blank"
                    style="background: url('<?php echo e(asset('assets/frontend/assets/images/icon/atmIcon.png')); ?>') no-repeat; width: 42px; height: 50px; display: block; text-indent: -99999px; outline: none; position: absolute; top: 0px; right: -57px;">atms</a>
...
<?php echo $__env->make('frontend.frontend-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp8.2\htdocs\uttara-banck\@core\resources\views/frontend/frontend-home.blade.php ENDPATH**/ ?>
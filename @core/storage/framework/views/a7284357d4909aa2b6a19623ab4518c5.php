            ...
            <?php $__currentLoopData = $all_header_slider; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="slide-item d-md-flex justify-content-between align-items-center">
                    <div class="promo-banner">
                        <div class="header-group">
                            <?php if(!empty($data->title)): ?>
                                <h1 class="title-primary"><?php echo e($data->title); ?></h1>
                            <?php endif; ?>
                            <?php if(!empty($data->subtitle)): ?>
                                <h2 class="title-secondary"><?php echo e($data->subtitle); ?></h2>
                            <?php endif; ?>
                        </div>
                        ...
                        <div class="button-wrapper">
                            <a class="btn-cta" href="<?php echo e(!empty($data->btn_01_url) ? $data->btn_01_url : '#'); ?>">
                    ...
                    <div class="video-container">
                        <img src="<?php echo e($image_details['img_url']); ?>" alt="slider images" width="100">
                    </div>
                </div>
...
<?php /**PATH D:\xampp8.2\htdocs\uttara-banck\@core\resources\views/frontend/partials/slide.blade.php ENDPATH**/ ?>
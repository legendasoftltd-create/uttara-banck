                    ...
                    <div class="card-body">
                       <div class="header-wrap d-flex align-content-center justify-content-between">
                           ...
                           <div class="right-wrap">
                               <a href="<?php echo e(route('admin.news.new')); ?>" class="btn btn-primary"><?php echo e(__('Create New News')); ?></a>
                           </div>
                       </div>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.delete-popover','data' => ['url' => route('admin.news.delete',$data->id)]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
                                                    ...
                                                    <a class="btn btn-xs btn-primary btn-xs mb-3 mr-1" href="<?php echo e(route('admin.news.edit',$data->id)); ?>">
                                                        <i class="ti-pencil"></i>
                                                    </a>
                                                    <a class="btn btn-xs btn-primary btn-xs mb-3 mr-1" target="_blank" href="<?php echo e(route('frontend.news.single', $data->slug)); ?>">
                                                        <i class="ti-eye"></i>
                                                    </a>
                                                    <form action="<?php echo e(route('admin.news.clone')); ?>" method="post" style="display: inline-block">
                                                        <?php echo csrf_field(); ?>
        ...
        $(document).ready(function() {
            $(document).on('click','#bulk_delete_btn',function (e) {
                ...
                if(allIds != '' && bulkOption == 'delete'){
                    ...
                    $.ajax({
                        'type' : "POST",
                        'url' : "<?php echo e(route('admin.news.bulk.action')); ?>",
                        'data' : {

                    ...
                    <div class="card-body">
                       <div class="header-wrap d-flex align-content-center justify-content-between">
                           ...
                           <div class="right-wrap">
                               <a href="<?php echo e(route('admin.blog.new')); ?>" class="btn btn-primary"><?php echo e(__('Create New News')); ?></a>
                           </div>
                       </div>
...
<?php endif; ?>
                                                    ...
                                                    <a class="btn btn-xs btn-primary btn-xs mb-3 mr-1" target="_blank" href="<?php echo e(route('frontend.news.single', $data->slug)); ?>">
                                                        <i class="ti-eye"></i>
                                                    </a>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/ubank.example.com/@core/resources/views/backend/pages/news/index.blade.php ENDPATH**/ ?>
                ...
                <div class="breadcrumb-inner">
                    ...
                    <ul class="page-list">
                        ...
                        <?php $__currentLoopData = $pages_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $page): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php if(\Illuminate\Support\Str::startsWith(request()->path(), get_static_option($page.'_page_slug'))): ?>
                            <li><?php echo e(get_static_option($page.'_page_' . $user_select_lang_slug . '_name')); ?></li>
                            <?php endif; ?>
...
<?php /**PATH D:\xampp8.2\htdocs\uttara-banck\@core\resources\views/frontend/partials/breadcrumb.blade.php ENDPATH**/ ?>
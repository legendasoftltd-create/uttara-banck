    ...
    <div class="content-body">
                        ...
                        <?php $__currentLoopData = $all_service; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="floatingMenu  floatingMenuMargin" data-aos="fade-up" data-aos-duration="500"
                                ...
                                <div class="text-center about-nav dropdown">
                                    ...
                                    <p class="m-0">
                                        <a href="<?php echo e(route('frontend.services.single', $service->slug)); ?>"><?php echo e($service->title); ?></a>
                                    </p>
                                </div>
                            </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        ...
        <section id="important"
            ...
            <div id="sticky-container">
                                <div class="sticky">
                                    <div class="head-stk">
                                        <div class="left-head"> <span
                                                class="rotate">Exchange&nbsp;Rates</span></div>
                            ...
                            <div class="content">
                                <div class="Robi-Ad"
                                    style="line-height: 1; position: fixed; height: 140px; right: -100px;">
                                    ...
                                    <a href="<?php echo e(route('frontend.locations')); ?>?tab=atm" target="_blank"><img
                                            src="<?php echo e(asset('assets/frontend/assets/images/icon/utarra_atm.png')); ?>"
                                            height="70" width="147"></a>
                                </div>
                                <!--pop up    -->
                                <div class="Cell-Ad"

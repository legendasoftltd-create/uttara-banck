        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="dynamic-page-content-wrap">
                    ...
                    <?php else: ?>
                        <?php echo iFrameFilterInSummernoteAndRender($page_post->content); ?>
...
<?php /**PATH D:\xampp8.2\htdocs\uttara-banck\@core\resources\views/frontend/partials/dynamic-page-content.blade.php ENDPATH**/ ?>
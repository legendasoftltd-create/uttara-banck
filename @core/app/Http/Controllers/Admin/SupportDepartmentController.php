...
class SupportDepartmentController extends Controller
{
    ...
    public function new_category(Request $request){
        ...
        return redirect()->back()->with(LegendaSoftHelpers::item_new());
    }
    ...
    public function update(Request $request){
        ...
        return redirect()->back()->with(LegendaSoftHelpers::item_update());
    }

    public function delete(Request $request,$id){
        SupportDepartment::find($id)->delete();
        return redirect()->back()->with(LegendaSoftHelpers::item_delete());
    }

...
use App\Helpers\LegendaSoftHelpers;
...
//
        ...
        return back()->with(LegendaSoftHelpers::item_new());
    }
    ...
    public function update(Request $request)
    {
        ...
        return back()->with(LegendaSoftHelpers::item_update());
    }
    ...
    public function delete($id)
    {
        ...
        CourseLessionLang::whereIn('lession_id', $all_lesson)->delete();
        return back()->with(LegendaSoftHelpers::item_delete());
    }
    ...
    public function clone(Request $request)
    {
        ...
        return back()->with(LegendaSoftHelpers::item_clone());
    }
    ...
    public function settings_update(Request $request){
        ...
        return back()->with(LegendaSoftHelpers::settings_update());
    }

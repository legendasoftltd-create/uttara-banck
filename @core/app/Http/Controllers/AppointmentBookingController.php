...
class AppointmentBookingController extends Controller
{
    ...
    public function approve_payment($id){
        ...
        try {
            ...
            return back()->with(LegendaSoftHelpers::item_delete(__('Payment Approved, Mail send Faild for').' '.$e->getMessage()));
        }
    ...
    public function booking_update(Request $request){
       ...
       $booking_details->booking_time_id = $request->booking_time_id;
        ...
        try {
            ...
            return back()->with(LegendaSoftHelpers::item_delete(__('Booking date and time updated, mail send failed').' '.$e->getMessage()));
        }

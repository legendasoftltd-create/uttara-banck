...
(function () {
    function p() {
        a("#ecww-widget-iframeinner").html('<form id="ecww-formwrapper" class="col-sm-12">' +
            '<div id="ecww-form"><div class="form-group"> ' +
            '<label for="ecww-loanamount" class="control-label">Loan Amount</label> ' +
            '<div class="input-group"> <span class="ecww-addon input-group-addon">' +
            '<span class="glyphicon glyphicon-rupee"></span></span> ' +
            ...
            '<span class="glyphicon glyphicon-percent"></span></span> ' +
            ...
            '<label for="ecww-loanterm" class="control-label">Duration</label> ' +
            '<div class="form-group"> <div class="ecww-tenure-choice"> ' +
            '<div class="btn-group" data-toggle="buttons"> ' +
            '<label class="btn btn-primary active"> ' +
            '<input type="radio" name="ecww-loantenure" id="ecww-loanyears" tabindex="4" autocomplete="off" checked/>Year </label> ' +
            '<label class="btn btn-primary"> ' +
            '<input type="radio" name="ecww-loantenure" id="ecww-loanmonths" tabindex="5" autocomplete="off"/>Month </label>' +
            '</div></div> <div class="ecww-inline-input-group"> ' +
            '<div class="input-group"> <span class="ecww-addon input-group-addon">' +
            ...
            '<div id="ecww-summary" class="col-sm-12">' +
            '<div id="ecww-monthlypayment" class="col-sm-3"><p>\u09F3 1,24,797</p><h4>EMI Calculated</h4></div>' +
            '<div id="ecww-totalinterest" class="col-sm-4"><p>\u09F3 34,90,279</p><h4>Total Interest</h4></div>' +
            '<div id="ecww-totalamount" class="col-sm-4"><p>\u09F3 59,90,279</p><h4>Total of Payments</h4></div></div>');
        h = {
            ...
            xAxis: {
                ...
                lineColor: "#000",
                tickColor: "#000",
                labels: {style: {color: "#000", font: "13px Helvetica, Arial, Verdana, sans-serif"}},
                title: {
                    style: {
                        color: "#888888",
                        fontWeight: "normal",
        ...
        Globalize.addCultureInfo("en-IN", "default", {
            ...
            numberFormat: {
                ...
                currency: {pattern: ["$ -n", "$ n"], groupSizes: [3, 2], symbol: "Rs."}
            },
            calendars: {
                standard: {
                    "/": "-", firstDay: 1,
        ...
        new Highcharts.Chart({
            ...
            plotOptions: {
                pie: {
                    ...
                    cursor: "pointer",
                    dataLabels: {
                        enabled: !0, distance: 10, color: "#444444", formatter: function () {
            ...
            series: [{
                ...
                data: [["Principal Loan Amount", e], {name: "Total Interest", y: f * b - e, sliced: !0, selected: !0}]
            }]
        })
    }
